...
const heroLinks: HeroLinkProps[] = [
    { link: 'https://github.com/jacobsalway', icon: faGithub },
    { link: 'https://www.linkedin.com/in/jacobsalway/', icon: faLinkedin },
]

type Props = Hero & Animatable

const HeroView: React.FC<Props> = ({ name, subtext, animate, onComplete }) => {
    return (
...
type HeroLinkProps = { link: string; icon: IconDefinition }
